...
func (this *TblLoader) Init() {
	...
	this.LoadExcel(TPalaceMapMasterLevelsBase, "palacemapmasterlevelsbase.json")
	this.LoadExcel(TFunctionOpen, "functionopenbase.json")
	this.LoadExcel(TMaidShopBase, "maidshopbase.json")
	this.LoadExcel(TRewardBase, "rewardbase.json")
	this.LoadExcel(GiftProBase, "giftprobase.json")
	this.LoadExcel(TTravelBase, "travelbase.json")
	this.LoadExcel(TBoxBase, "boxbase.json")
	this.LoadExcel(TPalaceMapMaidBase, "palacemapmaidbase.json")
	this.LoadExcel(TEventBase, "eventbase.json")
	this.LoadExcel(TPalaceMapBase, "palacemapbase.json")
	...
	this.LoadExcel(TShareBase, "sharebase.json")
	...
	this.LoadExcel(TDateEventBase, "dateeventbase.json")
	this.LoadExcel(TTurnBrandBase, "turnbrandbase.json")
	this.LoadExcel(TDateRewardBase, "daterewardbase.json")
	this.LoadExcel(TaskBase, "taskbase.json")
	this.LoadExcel(THeadBase, "headbase.json")
