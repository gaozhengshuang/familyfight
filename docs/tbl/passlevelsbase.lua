...
export var PassLevels : table.IPassLevelsDefine[] = [
		...
		{ Id : 5, Name : "假怀孕", Path : "Image/GameScene/Pass/pass_15", NextLevels : 6, DialogueID : 57, MapPrefab : "Prefab/map/map02", ChapterID : 2, ChapterName : "第二章", Index : 1 	},
		{ Id : 6, Name : "绣坊比赛", Path : "Image/GameScene/Pass/pass_16", NextLevels : 7, DialogueID : 51, MapPrefab : "Prefab/map/map06", ChapterID : 2, ChapterName : "第二章", Index : 2 	},
		{ Id : 7, Name : "皇后千秋", Path : "Image/GameScene/Pass/pass_4", NextLevels : 8, DialogueID : 25, MapPrefab : "Prefab/map/map04", ChapterID : 2, ChapterName : "第二章", Index : 3 	},
		{ Id : 8, Name : "初入长春宫", Path : "Image/GameScene/Pass/pass_5", NextLevels : 9, DialogueID : 25, MapPrefab : "Prefab/map/map02", ChapterID : 2, ChapterName : "第二章", Index : 4 	},
		{ Id : 9, Name : "新叶有毒", Path : "Image/GameScene/Pass/pass_8", NextLevels : 10, DialogueID : 33, MapPrefab : "Prefab/map/map03", ChapterID : 3, ChapterName : "第三章", Index : 1 	},
