...
export var PassLevels : table.IPassLevelsDefine[] = [
		...
		{ Id : 2, Name : "作弊", Path : "Image/GameScene/Pass/pass_2", NextLevels : 3, DialogueID : 33, MapPrefab : "Prefab/map/map04" 	},
		...
		{ Id : 5, Name : "作弊", Path : "Image/GameScene/Pass/pass_2", NextLevels : 6, DialogueID : 33, MapPrefab : "Prefab/map/map04" 	},
		{ Id : 6, Name : "泼水", Path : "Image/GameScene/Pass/pass_3", NextLevels : 7, DialogueID : 25, MapPrefab : "Prefab/map/map03" 	}
	]
