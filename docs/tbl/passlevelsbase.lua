...
export var PassLevels : table.IPassLevelsDefine[] = [
		...
		{ Id : 3, Name : "泼水", Path : "Image/GameScene/Pass/pass_3", NextLevels : 4, DialogueID : 25 	},
		{ Id : 4, Name : "绣女", Path : "Image/GameScene/Pass/pass_1", NextLevels : 5, DialogueID : 1 	},
		{ Id : 5, Name : "作弊", Path : "Image/GameScene/Pass/pass_2", NextLevels : 6, DialogueID : 7 	},
