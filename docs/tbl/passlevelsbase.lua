...
export var PassLevels : table.IPassLevelsDefine[] = [
		...
		{ Id : 3, Name : "皇后千秋", Path : "Image/GameScene/Pass/pass_4", NextLevels : 4, DialogueID : 7, MapPrefab : "Prefab/map/map04", ChapterID : 1, ChapterName : "第一章" 	},
		...
		{ Id : 11, Name : "皇后千秋", Path : "Image/GameScene/Pass/pass_4", NextLevels : 12, DialogueID : 7, MapPrefab : "Prefab/map/map04", ChapterID : 3, ChapterName : "第三章" 	},
