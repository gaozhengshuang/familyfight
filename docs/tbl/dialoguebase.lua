...
export var TDialogue : table.ITDialogueDefine[] = [
		...
		{ Id : 8, Index : 5, HeadSprite : [ "Image/Head/4" ], HeadLocation : [ 1 ], Name : "纳兰淳雪", NameLocation : 1, Content : "女子一耳带三钳，穿花盆鞋，乃是老祖宗留下的规矩，若是一朝抛弃，效法汉女一耳一坠，就是忘了祖宗。" 	},
		...
		{ Id : 12, Index : 6, HeadSprite : [ "Image/Head/2", "Image/Head/4" ], HeadLocation : [ 1, 2 ], Name : "乌雅青黛", NameLocation : 2, Content : "皇上，臣女这叫步步生莲。" 	},
		...
		{ Id : 17, Index : 6, HeadSprite : [ "Image/Head/2", "Image/Head/4" ], HeadLocation : [ 1, 2 ], Name : "乌雅青黛", NameLocation : 2, Content : "不要，皇上！不要啊！臣女知错了！对了，是那贱婢，是那贱婢害了臣女！不是我，往鞋底涂抹香粉的主意不是我……呜！" 	},
