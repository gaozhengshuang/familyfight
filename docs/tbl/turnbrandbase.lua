...
export var TurnBrand : table.ITurnBrandDefine[] = [
		...
		{ Id : 5, Name : "太监", Head : "Image/Head/3_round", Type : 1, RewardId : 0, Value : 20000, Dialogue : 0, Weight : 40 	},
		{ Id : 6, Name : "太医", Head : "Image/Head/6_round", Type : 1, RewardId : 0, Value : 50000, Dialogue : 0, Weight : 30 	}
	]
