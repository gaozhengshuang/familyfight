...
export var TurnBrand : table.ITurnBrandDefine[] = [
		...
		{ Id : 3, Name : "侍卫", Head : "Image/Head/5_round", Type : 4, RewardId : 10001, Value : 5, Dialogue : 0, Weight : 30 	},
		{ Id : 4, Name : "贵妃", Head : "Image/Head/4_round", Type : 4, RewardId : 10001, Value : 10, Dialogue : 0, Weight : 80 	},
