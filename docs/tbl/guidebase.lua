...
export var Guide : table.IGuideDefine[] = [
		...
		{ Id : 10, NextGuide : 11, Type : 1, IsDialog : 1, IsFinger : 1, Dialog : "刚才的宫女去哪里了？让我们点击按钮来切换地图找她。", prefab : "Prefab/GameSceneView", ButtonName : "cell_2", PersonXY : "0,-466", FingerXY : "", MaidInfo : "", Upload : true 	},
		{ Id : 11, NextGuide : 12, Type : 2, IsDialog : 1, IsFinger : 1, Dialog : "原来在这里，合并高等级宫女不仅可以开启新关卡，还能解锁新功能。", prefab : "", ButtonName : "", PersonXY : "0,233", FingerXY : "189,196", MaidInfo : "", Upload : true 	},
		...
		{ Id : 14, NextGuide : 15, Type : 5, IsDialog : 0, IsFinger : 0, Dialog : "", prefab : "Prefab/TurnBrandView", ButtonName : "BrandNodeParent4", PersonXY : "", FingerXY : "", MaidInfo : "", Upload : false 	},
