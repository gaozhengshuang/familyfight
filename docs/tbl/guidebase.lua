...
export var Guide : table.IGuideDefine[] = [
		...
		{ Id : 109, Resetid : 106, NextId : 110, Type : 1, IsDialog : 1, IsFinger : 1, Dialog : "让我们关闭招募看下。", prefab : "Prefab/ShopView", ViewName : "button_shopclose", ButtonName : "button_shopclose", PersonXY : "0,159", FingerXY : "", MaidInfo : "", ConditionType : 2, ConditionValue : 0 	},
