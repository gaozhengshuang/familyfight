...
export var Guide : table.IGuideDefine[] = [
		...
		{ Id : 209, Resetid : 301, NextId : 210, Type : 1, IsDialog : 1, IsFinger : 1, Dialog : "放好了，点确定关闭界面。根据你放入的物品会触发宫里的很多随意事件。", prefab : "Prefab/TravelView", ViewName : "ConfirmButton", ButtonName : "ConfirmButton", PersonXY : "0,-273", FingerXY : "", MaidInfo : "", ConditionType : 2, ConditionValue : 0 	},
