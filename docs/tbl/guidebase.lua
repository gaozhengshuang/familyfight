...
export var Guide : table.IGuideDefine[] = [
		...
		{ Id : 210, Resetid : 401, NextId : 211, Type : 1, IsDialog : 1, IsFinger : 1, Dialog : "咦，你好像触发了神秘事件!", prefab : "Prefab/EventDetailView", ViewName : "view", ButtonName : "CloseButton", PersonXY : "0,-466", FingerXY : "", MaidInfo : "", ConditionType : 2, ConditionValue : 0 	},
