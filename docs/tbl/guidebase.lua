...
export var Guide : table.IGuideDefine[] = [
		...
		{ Id : 204, Resetid : 201, NextId : 205, Type : 1, IsDialog : 1, IsFinger : 1, Dialog : "点击购买按钮", prefab : "Prefab/PalaceMaidDetailView", ViewName : "button_buy", ButtonName : "button_buy", PersonXY : "0,-276", FingerXY : "", MaidInfo : "", ConditionType : 2, ConditionValue : 0 	},
